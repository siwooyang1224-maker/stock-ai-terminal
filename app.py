...
with tab3:
    ...
    # 3. LLM API 우회용 프롬프트 생성기
    st.markdown("#### 🤖 AI 정성 분석 프롬프트 생성기 (Token Free)")
    st.markdown("<p style='font-size: 13.5px; color: #495057;'>API 오류나 토큰 부족 시, 아래의 <b>맞춤형 프롬프트</b>를 복사하여 ChatGPT나 Gemini에 직접 붙여넣으세요. 현재 시장 데이터가 반영되어 있습니다.</p>", unsafe_allow_html=True)
